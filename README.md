# babygiant-alt-bn128
A Rust crate implementing a multi-threaded version of the baby-step giant-step algorithm on the Baby Jubjub curve (it is the curve whose base field is alt-bn-128 aka bn254) to decrypt u40 integers.
